    ...
    private fun generateBindings() {
        binding.navigationBar.navigationBar.setOnItemSelectedListener { item ->
            when (item.itemId) {
                ...
                R.id.footer_kitchen_btn -> findNavController().navigate(KitchenFragmentDirections
                    .kitchenToKitchen().setBackButton(R.id.kitchen_to_kitchen))

                R.id.footer_rooms_btn -> findNavController().navigate(KitchenFragmentDirections
                    .kitchenToRooms().setBackButton(R.id.rooms_to_kitchen))
            }
            true
        }
